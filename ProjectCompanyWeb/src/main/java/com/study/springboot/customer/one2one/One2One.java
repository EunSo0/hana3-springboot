...
public class One2One {
  ...
  @Builder
  public One2One(Long one2oneIdx, String one2oneName, String one2onePhone, String one2oneEmail, String one2oneAddress, String one2oneTitle, String one2oneContent, LocalDateTime one2oneDate) {
    this.one2oneIdx = one2oneIdx;
